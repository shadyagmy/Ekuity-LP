...
$( document ).ready(function() {
    ...
    // SLIDER WITH ANIMATION SCRIPT
    $(".anim-slider").animateSlider(
        {
            autoplay    :   true,   //starts the autoplay 
            interval    :   6000,   //time between slides if autoplay is true
    ...
    function TestiSwiper() { 
        if ($(window).width() <= 800) {  
             testimonialsSwiper = new Swiper('.swiper-container.testimonials_swiper', {
                slidesPerView: 2,
                spaceBetween: 30,
                pagination: {
    ...
    //   OWL carousel custimization

    $('.owl-carousel.sectors__carousel').owlCarousel({
        stagePadding: 170,
        center: true,
        items:1,
        dots: false,
        ...
        loop:true,
        margin:0,
        navText: ['<img src="img/arrow-L.png" alt="arrow left">','<img src="img/arrow-R.png" alt="arrow left">'],
        responsive:{
            0:{
                stagePadding: 0,
            },
    ...
    $('.owl-carousel.features__carousel').owlCarousel({
        items:1,
        dots: false,
        nav:true,
        loop:true,
        margin:0,
        navText: ['<img src="img/arrow-b-L.png" alt="arrow left">','<img src="img/arrow-b-R.png" alt="arrow left">']
    ...
    // Hover on menu popup links

    $(".popup__menu--link a").hover(function(){
        $(this).toggleClass("heading__with__lines");
    })

    $(".popup__menu--link a.home").addClass("heading__with__lines");
    $(".popup__menu--link a.home").hover(function(){
        $(this).addClass("heading__with__lines");
    })
    


    $(".popup__outline__nav img").on('click', () => {
        $('#Menupopup').fadeToggle();
        $('body').toggleClass('noOverflow')
    })

    $(".nav__menu img").on('click', () => {
        $('#Menupopup').fadeToggle();
        $('body').toggleClass('noOverflow')
    })
